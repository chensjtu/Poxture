...
class IPERDataset(DatasetBase):
    ...
    def _read_dataset_paths(self):
        ...
        self._vids_dir = os.path.join(self._root, "primitives")
    ...
    def _read_vids_info(self, file_path):
        smpl_data_dir = '/media/Diskd/projects/eft/dataset/smpls'
        ...
        with open(file_path, 'r') as reader:
            ...
            for line in tqdm(lines):
                images_path = glob.glob(os.path.join(self._vids_dir, line, "processed/images", "*"))
                images_path.sort()

                alphas_path = glob.glob(os.path.join(self._vids_dir, line, "processed/parse", "*_alpha.png"))
                alphas_path.sort()

                smpl_data = load_pickle_file(os.path.join(smpl_data_dir, line, "pose_shape.pkl"))
                cams = smpl_data["cams"]
