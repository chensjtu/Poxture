...
import functools
from .SurfaceClassifier import SurfaceClassifier, neural_texture
...
class ResBlkPIFuNet(BasePIFuNet):
    def __init__(self, opt,
        ...
        self.SurfaceClassifier = SurfaceClassifier(
